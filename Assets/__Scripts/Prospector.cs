...
    }
    ...
    void LayoutGame()
    {
        ...
        if(layoutAnchor == null)
        {
            ...
            // ^ Create an empty GameObject named _LayoutAnchor in theHierarchy
...
            layoutAnchor.transform.position = layoutCenter;
        ...
        foreach(SlotDef tSD in layout.slotDefs)
        {
            ...
            tableau.Add(cp);
            // Add this CardProspector to the List<> tableau    
        }
...
            Vector2 dpStagger = layout.drawPile.stagger;
            cd.transform.localPosition = new
            Vector3(layout.multiplier.x * (layout.drawPile.x + i * dpStagger.x), layout.multiplier.y * (layout.drawPile.y + i * dpStagger.y), -layout.drawPile.layerID + 0.1f * i);
...
            cd.SetSortingLayerName(layout.drawPile.layerName);
    ...
    public void CardClicked(CardProspector cd)
    {
        ...
        switch (cd.state)
        {
            ...
            case eCardState.drawpile:
                ...
                // Moves the target to the discardPile
                MoveToTarget(Draw());
                // Moves the next drawn card to the target
    ...
    void CheckForGameOver()
    {
        ...
        // If there are still cards in the draw pile, the game's not 
        if (drawPile.Count > 0)
        {
            return;
        }
